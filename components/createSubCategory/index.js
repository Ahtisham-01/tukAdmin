...
const Index = ({ setAddSubCategory, allSubcategories, setSubcategoryItem, allCategory }) => {
    ...
    return (
        <React.Fragment>
            <div className="w-full pb-[56px] ">
                <div className="overflow-x-auto py-2 px-2 border border-zinc-200 rounded-xl bg-white lg:overflow-x-clip">
                    <table className="table-auto border-collapse w-full  ">
                        <thead>
                            <tr className="flex justify-between  h-[63px] items-center">
                                {/* <th className="max-w-[63px] min-w-[63px] w-full text-start font-semibold text-base leading-[150%] py-4"></th> */}
                                <th className=" w-full max-w-[224px] min-w-[224px] text-start font-semibold text-base leading-[150%] py-4  px-4">
                        ...
                        <tbody className="flex flex-col max-w-[1124px] ">
                            {allSubcategories?.length ? (
                                allSubcategories?.slice().reverse()?.map((item, index) => {
                                    return (
                                        <tr
                                        ...
                                        >
                                            ...
                                            <td className="w-full max-w-[224px] min-w-[224px] text-start flex items-center font-normal text-sm leading-[150%] px-[16px] ">
                                                {item.categoryId
                                                    ? allCategory !== undefined && allCategory[index]?.name
                                                    : "N/A"}
                                            </td>
