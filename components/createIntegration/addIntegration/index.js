...
import { useCreateIntegrationMutation, useUpdateIntegrationMutation } from "../../../features/api/dataApiSlice"

const Index = ({ setaddIntegration, allComponents, addIntegration, customerData, setIntegrationItem, IntegrationItem }) => {
    // license info states
            ...
            <main className="bg-white flex xl:flex-nowrap flex-col  flex-wrap pt-0 pb-7 gap-8">
                ...
                >
                    <div className="rounded-md w-full">
                        ...
                        <div className="mt-5">
                            <label htmlFor="licensesId" className="pt-5 text-[#27272A] text-sm font-semibold leading-tight tracking-normal mb-2">Select FrameWork</label>
                            <select name="type"
                                ...
                                <option value="" disabled hidden selected>Select FrameWork</option>
                                {
                                    ['React', 'Vue', 'Angular', 'Html']?.map((it, i) => {
                                        return (
                        ...
                        <div className="mt-5">
                            ...
                            <label htmlFor="Description" className=" text-zinc-800 text-sm leading-[14px] font-medium manrope_font ">Enter code there</label>
                            <textarea id="label" value={code} type="text" required onChange={event => setCode(event.target.value)} className="text-gray-600 focus:outline-none focus:border focus:border-indigo-500 font-normal w-full h-20 flex items-center pl-3 py-2 text-sm border-gray-300 rounded border shadow" placeholder="" />
