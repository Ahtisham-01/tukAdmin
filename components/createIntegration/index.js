...
const Index = ({ setaddIntegration, setIntegrationItem, filterValue, allComponents }) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td className=" w-full max-w-[224px] min-w-[224px] text-start flex items-center font-normal text-sm leading-[150%] px-[16px] ">
                                                    {item?.framework ? (item?.framework?.charAt(0).toUpperCase() + item?.framework?.slice(1)) : "N/A"}
                                                </td>
                                                <td className="  text-start  max-w-[224px] min-w-[224px]  font-normal text-[12px] leading-[150%] px-4 py-4 flex  items-center">
                                                    {item?.componentsId
                                                        ? allComponents !== undefined && allComponents[index]?.name
                                                        : "N/A"}
                                                </td>
                                                <td className=" w-full min-w-[200px]  overflow-hidden max-w-[200px] flex items-center text-start font-normal text-sm leading-[14px]  px-[16px]">
